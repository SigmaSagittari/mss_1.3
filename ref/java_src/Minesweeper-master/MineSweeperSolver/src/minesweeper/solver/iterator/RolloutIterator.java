 ...
 * @author David
 */
public class RolloutIterator extends Iterator {
    ...
    public RolloutIterator(RolloutGenerator generator, int mines) {
        this(generator, mines, -1);
    }
    
    
    // create an iterator which is like a set of rotating wheels
    public RolloutIterator(RolloutGenerator generator, int mines, int rotation) {
         super(mines, generator.getWeb().getSquares().size());
